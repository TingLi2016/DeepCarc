...
base_path = '/account/tli/carcinogenecity/results/mold2/para_selection/xgboost'
...
for i in range(200):
    ...
    for train_index, validation_index in skf.split(X, y):
        ...
        col_name1 = 'xgboost_'+'seed_'+str(i)+'_paras_'+var+'_lr_'+str(para[0])+'_n_'+str(para[1])+'_depth_'+str(para[2])+'_subsample_'+str(para[3])+'_scale_pos_weight_'+str(para[4])
