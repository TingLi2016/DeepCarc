...
base_path = '/account/tli/carcinogenecity/results/mold2/para_selection/rf'
...
for i in range(200):
    ...
    for train_index, validation_index in skf.split(X, y):
        ...
        ### define column name 
        col_name = 'rf_'+'seed_'+str(i)+'_skf_'+str(j)+'_paras_'+var+'_estimator_'+str(para[0])+'_depth_'+str(para[1])+'_random_'+str(para[2])+'_leaf_'+str(para[3])+'_weight_'+str(para[4])
        col_name1 = 'rf_'+'seed_'+str(i)+'_paras_'+var+'_estimator_'+str(para[0])+'_depth_'+str(para[1])+'_random_'+str(para[2])+'_leaf_'+str(para[3])+'_weight_'+str(para[4])
