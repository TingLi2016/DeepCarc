...
def combine_validation_probabilities(n):
    ...
    tmp = pd.read_csv(join(knn_base_path, 'validation_knn_paras_0_K_3.csv'))
    knn = tmp[['id', 'y_true']]
    ...
    tmp = pd.read_csv(join(lr_base_path, 'validation_lr_paras_0.csv'))
    lr = tmp[['id', 'y_true']]
    ...
    tmp = pd.read_csv(join(rf_base_path, 'validation_rf__paras_5.csv'))
    rf = tmp[['id', 'y_true']]
    ...
    tmp = pd.read_csv(join(xgboost_base_path, 'validation_xgboost_paras_89.csv'))
