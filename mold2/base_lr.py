...
base_path = '/account/tli/carcinogenecity/results/mold2/para_selection/lr'
...
for i in range(200):
    ...
    for train_index, validation_index in skf.split(X, y):
        ...
        ### define column name
        col_name = 'lr_'+'seed_'+str(i)+'_skf_'+str(j)+'_paras_'+var+'_C_'+str(para[0])+'_weight_'+str(para[1])
        col_name1 = 'lr_'+'seed_'+str(i)+'_paras_'+var+'_C_'+str(para[0])+'_weight_'+str(para[1])
