...
tmp = pd.read_csv('/account/tli/carcinogenecity/data/maccs/carcinogenicity_maccs_138.csv',low_memory=False)
cols = tmp.columns[10:]
...
base_path = '/account/tli/carcinogenecity/results/maccs/para_selection/svm'
